...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <div class="form-horizontal">
        <fieldset>
            ...
            <p>Enter your email and pick a password.<br />
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                 ...
                 <p>Please enter your desired password below. The password must be <strong>at least</strong> 8 characters long.</strong><br />
                </p>
