<%@ Page Title="Edit Account" Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="Edit.aspx.cs" Inherits="Concordia42.Account.Edit" %>
    ...
    <div class="form-horizontal">
       <fieldset>
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                <asp:DropDownList ID="classLevel" runat="server" ToolTip="Your Class Level" CssClass="form-control" AppendDataBoundItems="true">
        ...
        <div class="form-group">
            <asp:Button runat="server" Text="Edit &raquo;" CssClass="btn btn-primary" ID="FinishBtn" OnClick="FinishBtn_Click" />
        </div>
